export const FLOORS_DATA = [
  ...
  },
  {
    ...
    rooms: [
      ...
      { id: '403', number: 'Кабинет 403', name: 'Медиацентр', x: 34, y: 12, icon: 'icons/FourthIcons/Camera.svg', size: 'xs', staff: [ { role: "Медиацентр", name: "Жаров Алексей Геннадьевич", roomLabel: "403 каб.", phone: "https://vk.ru/studentmediaspace", photo: "photos/FourthFloor/Zharov.jpg" } ] },
