export const FLOORS_DATA = [
  {
    ...
    legend: [
      ...
      { icon: '/public/icons/FirstIcons/Cafe.svg', label: 'Бистро "Апельсин"' },
      { icon: '/public/icons/FirstIcons/Stolovaya.svg', label: 'Столовая "Ариадна"' },
      { icon: '/public/icons/FirstIcons/Biblioteka.svg', label: 'Библиотека' },
      { icon: '/public/icons/FirstIcons/Pencil.svg', label: 'Канцелярия' },
      { icon: '/public/icons/FirstIcons/Voenkom.svg', label: 'Специалист по военкомату' },
      { icon: '/public/icons/FirstIcons/StudyOffice.svg', label: 'Учебный отдел' },
      { icon: '/public/icons/FirstIcons/Ohrana.svg', label: 'Отдел безопасности' },
      { icon: '/public/icons/FirstIcons/Deans.svg', label: 'Деканат' },
    ],
    rooms: [
      { id: '107', number: '107', name: 'Кабинет 107', description: 'Специалист по воинскому учёту', x: 74, y: 86, icon: '/public/icons/FirstIcons/Voenkom.svg', size: 'sm', staff: [ { role: "Специалист по воинскому учёту", name: "Чиркова Марина Владимировна", roomLabel: "107 каб.", phone: "+7 (950) 741-77-12", photo: "/public/photos/FirstFloor/Chirkova.svg" } ] },
      { id: 'Clothes', number: '', name: 'Гардероб', description: 'Здесь можно оставить верхнюю одежду', x: 71, y: 68, icon: '/public/icons/FirstIcons/Clothes.svg', size: 'sm' },
      { id: 'Cafe', number: '', name: 'Бистро "Апельсин"', description: 'Здесь можно перекусить', x: 40, y: 70, icon: '/public/icons/FirstIcons/Cafe.svg', size: 'sm' },
      ...
      { id: '109', number: '109', name: 'Деканат', description: 'Деканат МИДиС', x: 86, y: 86, icon: '/public/icons/FirstIcons/Deans.svg', size: 'sm', staff: [ { role: "Заведующий отделением заочного обучения", name: "Блудова Анна Георгиевна", roomLabel: "109 каб.", phone: "+7 (351) 216-10-18", photo: "/public/photos/FirstFloor/Bludova.jpg" }, { role: "Специалист по учебно-методической работе (кафедры математики и информатики, кафедры экономики и управления)", name: "Демакова Инна Игоревна", roomLabel: "109 каб.", phone: "+7 (351) 216-10-09", photo: "/public/photos/FirstFloor/Demakova.jpg" }, { role: "Специалист по учебно-методической работе (кафедры гостеприимства и международных бизнес-коммуникаций)", name: "Казанцева Ольга Юрьевна", roomLabel: "109 каб.", phone: "+7 (351) 216-10-26", photo: "/public/photos/FirstFloor/Kazantseva.jpg" }, { role: "Ведущий специалист учебно-методического управления", name: "Кравченко Марина Алексеевна", roomLabel: "109 каб.", phone: "+7 (351) 216-10-18", photo: "/public/photos/FirstFloor/Kravchenko.jpg" } ] },
      { id: 'Canz', number: '', name: 'Канцелярия', description: 'Магазин канцелярских предметов', x: 76, y: 23, icon: '/public/icons/FirstIcons/Pencil.svg', size: 'sm' },
      { id: '111', number: '111', name: 'Учебный отдел', description: 'Учебно-методический отдел', x: 90, y: 78, icon: '/public/icons/FirstIcons/StudyOffice.svg', size: 'sm', staff: [ { role: "Диспетчер УМУ", name: "Докучаева Полина Алексеевна", roomLabel: "111 каб.", phone: "", photo: "/public/photos/FirstFloor/Dokuchaeva.jpg" }, { role: "Диспетчер УМУ", name: "Боровинских Наталья Владимировна", roomLabel: "111 каб.", phone: "", photo: "/public/photos/FirstFloor/Borovinskih.jpg" }, { role: "Начальник учебно-методического управления", name: "Михалина Алёна Владимировна", roomLabel: "111 каб.", phone: "+7 (351) 216-10-38", photo: "/public/photos/FirstFloor/Mihalina.jpg" } ] },
      { id: 'WC1', number: '', name: 'Туалеты', description: 'Мужской и женский туалет', x: 35, y: 66, icon: '/public/icons/FirstIcons/Toilet.svg', size: 'sm' },
      { id: 'WC2', number: '', name: 'Туалеты', description: 'Мужской и женский туалет', x: 27, y: 66, icon: '/public/icons/FirstIcons/Toilet.svg', size: 'sm' },
      { id: 'WC3', number: '', name: 'Туалеты', description: 'Мужской и женский туалет', x: 69, y: 15, icon: '/public/icons/FirstIcons/Toilet.svg', size: 'sm' },
      { id: '104', number: '104', name: 'Отдел безопасности', description: 'Отдел безопасности МИДиС', x: 35, y: 86, icon: '/public/icons/FirstIcons/Ohrana.svg', size: 'sm' },
      { id: 'Book', number: '122', name: 'Библиотека', description: 'Здесь можно взять любой учебный материал', x: 40, y: 35, icon: '/public/icons/FirstIcons/Biblioteka.svg', size: 'sm', staff: [ { role: "Заведующая библиотекой", name: "Сигитова Юлия Николаевна", roomLabel: "122 каб.", phone: "+7 (351) 216-10-19", photo: "/public/photos/FirstFloor/Sigitova.png" } ] },
    ]
  },
  {
    id: 'inst_f2',
