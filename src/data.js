export const FLOORS_DATA = [
  ...
  },
  {
    ...
    rooms: [
      ...
      { id: '406', number: 'Кабинет 406', name: 'Научно-методический отдел', x: 70, y: 46, icon: 'icons/FourthIcons/Highlighter.svg', size: 'xs', staff: [ { role: "Заведующий научно-методическим отделом", name: "Кокорин Сергей Александрович", roomLabel: "406 каб.", phone: "+7 (351) 216-10-50", photo: "photos/FourthFloor/Kokorin.jpg" }, { role: "Документовед", name: "Хаятова Лилия Рэхтямовна", roomLabel: "406 каб.", phone: "+7 (351) 216-10-15", photo: "photos/FourthFloor/Hayatova.jpg" }, { role: "Специалист научно-методического отдела", name: "Борисенко Екатерина Геннадьевна", roomLabel: "406 каб.", photo: "photos/ThirdFloor/Avatar.jpg" } ] },
  ...
  },
  {
    ...
    rooms: [
      ...
      { id: 'Med', number: 'Кабинет 107', name: 'Медпункт', x: 41.5, y: 93, icon: 'icons/SchoolFirstIcons/Medic.svg', size: 'xs', workingHours: {
