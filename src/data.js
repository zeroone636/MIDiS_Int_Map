export const FLOORS_DATA = [
  ...
  },
  {
    ...
    rooms: [
      ...
      { id: '312', number: 'Кабинет 312', name: 'Отдел практики и трудоустройства', x: 71, y: 45.5, icon: 'icons/ThirdIcons/Job.svg', size: 'xs', staff: [ { role: "Отдел практики и трудоустройства", name: "Аполовников Андрей Анатольевич", roomLabel: "312 каб.", phone: "+7 (351) 216-10-37", photo: "" } ] },
  ...
  },
  {
    ...
    rooms: [
      ...
      { id: '405', number: 'Кабинет 405', name: 'Отдел СПО', x: 60, y: 33, icon: 'icons/FourthIcons/Book.svg', size: 'xs', staff: [ { role: "Заведующий отделением среднего профессионального образования", name: "Хаятова Лилия Рэхтямовна", roomLabel: "405 каб.", phone: "+7 (351) 216-10-15", photo: "photos/FourthFloor/Hayatova.jpg" } ] },
      { id: '406', number: 'Кабинет 406', name: 'Научно-методический отдел', x: 60, y: 46, icon: 'icons/FourthIcons/Highlighter.svg', size: 'xs', staff: [ { role: "Заведующий научно-методическим отделом", name: "Кокорин Сергей Александрович", roomLabel: "406 каб.", phone: "+7 (351) 216-10-50", photo: "photos/FourthFloor/Kokorin.jpg" }, { role: "Документовед", name: "Хаятова Лилия Рэхтямовна", roomLabel: "406 каб.", phone: "+7 (351) 216-10-15", photo: "photos/FourthFloor/Hayatova.jpg" } ] },
