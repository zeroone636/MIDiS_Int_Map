export const FLOORS_DATA = [
  {
    ...
    rooms: [
      ...
      { id: '104', number: 'Кабинет 104', name: 'Отдел безопасности', description: 'Отдел безопасности МИДиС', x: 35, y: 86, icon: 'icons/FirstIcons/Ohrana.svg', size: 'xs' },
  ...
  },
  {
    ...
    rooms: [
      ...
      { id: '211', number: 'Кабинет 211', name: 'Проректор по учебно-проектной работе', x: 90, y: 89, icon: 'icons/SecondIcons/Director.svg', size: 'xs', staff: [ { role: "Проректор по учебно-проектной работе", name: "Попова Наталья Аркадьевна", roomLabel: "211 каб.", phone: "+7 (351) 216-10-20", photo: "photos/SecondFloor/Director.jpg" } ] },
  ...
  },
  {
    ...
    rooms: [
      ...
      { id: '305', number: 'Кабинет 305', name: 'Кафедра дизайна', description: 'Основная база кафедры дизайна и графики', x: 33, y: 85, icon: 'icons/ThirdIcons/kist.svg', size: 'xs' },
      ...
      { id: '312', number: 'Кабинет 312', name: 'Отдел практики и трудоустройства', description: 'Отдел практики и трудоустройства', x: 71, y: 45.5, icon: 'icons/ThirdIcons/Job.svg', size: 'xs' },
      { id: '314', number: 'Кабинет 314', name: 'Проектно-аналитический офис', x: 71, y: 40, icon: 'icons/ThirdIcons/Analytics.svg', size: 'xs', staff: [ { role: "Руководитель проектно-аналитического центра", name: "Львов Леонид Васильевич", roomLabel: "314 каб.", phone: "+7 (351) 216-10-??", photo: "photos/ThirdFloor/Lvov.png" } ] },
    ]
  },
  {
    id: 'inst_f4',
    ...
    rooms: [
      { id: '401', number: 'Кабинет 401', name: 'Кабинет 401', x: 16, y: 58, icon: 'icons/FourthIcons/fx.svg', size: 'xs', staff: [ { role: "Заведующий кафедрой математики и информатики", name: "Кондаков Сергей Александрович", roomLabel: "401 каб.", phone: "+7 (351) 216-10-05", photo: "photos/FourthFloor/Kondakov.jpg" } ] },
      { id: '404', number: 'Кабинет 404', name: 'Психолог', x: 60, y: 24, icon: 'icons/FourthIcons/Neuro.svg', size: 'xs', staff: [ { role: "Психолог", name: "Долгих Алёна Александровна", roomLabel: "404 каб.", phone: "https://vk.ru/alena.dolgih86", photo: "photos/FourthFloor/Dolgih.jpg" } ] },
      { id: '405', number: 'Кабинет 405', name: 'Отдел СПО', x: 60, y: 33, icon: 'icons/FourthIcons/Book.svg', size: 'xs', staff: [ { role: "Заведующий отделением среднего профессионального образования", name: "Хаятова Лилия Рэхтямовна", roomLabel: "405 каб.", phone: "+7 (351) 216-10-50", photo: "photos/FourthFloor/Hayatova.jpg" } ] },
      { id: '406', number: 'Кабинет 406', name: 'Научно-методический отдел', x: 60, y: 46, icon: 'icons/FourthIcons/Highlighter.svg', size: 'xs', staff: [ { role: "Заведующий научно-методическим отделом", name: "Кокорин Сергей Александрович", roomLabel: "406 каб.", phone: "+7 (351) 216-10-50", photo: "photos/FourthFloor/Kokorin.jpg" }, { role: "Документовед", name: "Хаятова Лилия Рэхтямовна", roomLabel: "406 каб.", phone: "+7 (351) 216-10-50", photo: "photos/FourthFloor/Hayatova.jpg" } ] },
      { id: '407', number: 'Кабинет 407', name: 'Преподавательская кафедры психологии и гуманитарных дисциплин', description: 'Преподавательская кафедры психологии и гуманитарных дисциплин', x: 60, y: 63, icon: 'icons/FourthIcons/Mind.svg', size: 'xs' },
      { id: '408', number: 'Кабинет 408', name: 'Преподавательская кафедры математики и информатики', x: 70, y: 78, icon: 'icons/FourthIcons/Office.svg', size: 'xs' },
    ]
  },
  {
    id: 'sch_f1',
